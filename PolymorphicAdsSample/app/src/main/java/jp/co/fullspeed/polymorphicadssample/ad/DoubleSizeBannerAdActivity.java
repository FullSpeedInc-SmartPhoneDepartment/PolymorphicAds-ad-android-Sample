...
/**
 * ダブルサイズバナー広告を利用したサンプルアクティビティ.
 */
public class DoubleSizeBannerAdActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.double_size_banner_sample_activity);

        // ① 広告ユニット初期化
        PolymorphicAds.init(this, AdUnitIdConst.DOUBLE_SIZE_BANNER_AD_UNIT_ID, PolymorphicAds.AdType.DOUBLE_SIZE_BANNER, R.id.ad_container);

        // ② 広告ロード（Ad情報取得、表示）
        PolymorphicAds.load(AdUnitIdConst.DOUBLE_SIZE_BANNER_AD_UNIT_ID);
    }
    ...
    protected void onPause() {
        super.onPause();
        // 広告ローテーション中断
        PolymorphicAds.pause(AdUnitIdConst.DOUBLE_SIZE_BANNER_AD_UNIT_ID);
    }
    ...
    protected void onResume() {
        super.onResume();
        // 広告ローテーション再開
        PolymorphicAds.resume(AdUnitIdConst.DOUBLE_SIZE_BANNER_AD_UNIT_ID);

        // （任意） コールバックセット
        PolymorphicAds.setCallback(
                AdUnitIdConst.DOUBLE_SIZE_BANNER_AD_UNIT_ID,
                this,
