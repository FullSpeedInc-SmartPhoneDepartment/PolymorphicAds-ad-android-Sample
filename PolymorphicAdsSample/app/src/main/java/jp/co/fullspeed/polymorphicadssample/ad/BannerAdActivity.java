...
/**
 * バナー広告を利用したサンプルアクティビティ.
 */
public class BannerAdActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.banner_sample_activity);

        // ① 広告ユニット初期化
        PolymorphicAds.init(this, AdUnitIdConst.BANNER_AD_UNIT_ID, PolymorphicAds.AdType.BANNER, R.id.ad_container);

        // ② 広告ロード（Ad情報取得、表示）
        PolymorphicAds.load(AdUnitIdConst.BANNER_AD_UNIT_ID);
    }
    ...
    protected void onPause() {
        super.onPause();
        // 広告ローテーション中断
        PolymorphicAds.pause(AdUnitIdConst.BANNER_AD_UNIT_ID);
    }
    ...
    protected void onResume() {
        super.onResume();
        // 広告ローテーション再開
        PolymorphicAds.resume(AdUnitIdConst.BANNER_AD_UNIT_ID);

        // （任意） コールバックセット
        PolymorphicAds.setCallback(
                AdUnitIdConst.BANNER_AD_UNIT_ID,
                this,
